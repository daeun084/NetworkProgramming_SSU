...
def server(host, port, certfile, cafile=None):
    # PEM file contain server's pv and certificate
    ...
    print('Connection from host {!r} from port {}'.format(*address))

    # Server does not need to specify the host to connect
...
if __name__ == "__main__":
    ...
    parser.add_argument('-s', metavar='certfile', default=None,
                        help='run as serever: path to server PEM file')
